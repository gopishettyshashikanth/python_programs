...
for i in range(p):
    ...
    provider_data['districtCode'] = districtcodenum
    provider_data['districtName'] = randon_string_generator(10, 'char').title()
    ...
    provider_data['stateCode'] = states[statesRandomIndex]
    provider_data['stateName'] = randon_string_generator(12, 'char').title()  
    ...
    login_trans_data['statecode'] = states[statesRandomIndex]
    login_trans_data['districtcode'] = districtcodenum
    ...
    service_count_data['district_code'] = districtcodenum
    service_count_data['state_code'] = 28
